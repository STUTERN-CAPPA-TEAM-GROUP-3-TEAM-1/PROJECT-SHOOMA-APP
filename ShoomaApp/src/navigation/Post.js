        ...
        <View style={{ marginLeft: 15, marginRight: 15 }}>
          ...
          >
            <View style={{ marginRight: 5 }}>
              ...
              />
              <Text style={{ textAlign: "center" }}> Klesanmi.j</Text>
              <Image
          ...
          >
            <View style={{ marginRight: 5 }}>
              ...
              />
              <Text style={{ textAlign: "center" }}> Sunmade.i</Text>
              <Image
                source={require("../assets/icons/more.png")}
                style={{
                  width: 20,
            ...
            <View style={{ width: "75%" }}>
              <View style={{ marginBottom: 10 }}>
                <Text style={{ fontSize: 12 }}>
                  Sometimes we make the process more complicated than we need
                  to. We will never make a journey of a thousand miles by
                  fretting about how long it will take.
                </Text>
              </View>
